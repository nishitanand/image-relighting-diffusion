"""
Inference script for InstructPix2Pix trained model
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run InstructPix2Pix inference")
    parser.add_argument(
        "--model_path",
        type=str,
        required=True,
        help="Path to trained model (e.g., ./output/instruct-pix2pix-sd15/final_model)",
    )
    parser.add_argument(
        "--input_image",
        type=str,
...
def run_inference(
    ...
    """Run inference with the InstructPix2Pix model"""
